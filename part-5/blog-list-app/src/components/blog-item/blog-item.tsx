      ...
      <div style={contentStyle} className='pt-4'>
        ...
        <div className='flex items-center justify-between gap-x-4'>
          <div className='flex gap-x-2 items-center text-gray-600'>
            <button className='p-2 rounded-full bg-gray-200 text-gray-600 transition-all hover:bg-pink-200 hover:text-pink-600 focus:ring-4 focus:ring-pink-100 focus:text-pink-600 focus:bg-pink-200' onClick={onLikeBlog}>
