...
const Note: FC<NoteProps> = ({note,OnToggleImportance}) => {
   ...
   const button = note.important ? 
      (<button onClick={OnToggleImportance} type='button' className='flex gap-2 items-center rounded-sm text-sm font-semibold transition-colors px-6 py-1.5 bg-red-600 hover:bg-red-700 text-white focus:ring-4 focus:ring-red-200'>
      ...
      : 
      (<button onClick={OnToggleImportance} type='button' className='flex gap-2 items-center rounded-sm text-sm font-semibold transition-colors px-6 py-1.5 bg-green-600 hover:bg-green-700 text-white focus:ring-4 focus:ring-green-200'>
